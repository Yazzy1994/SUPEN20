...
namespace SUPEN20DB.DbContexts
{
    public class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<SUPEN20DbContext>
    {
        ...
        {
            IConfigurationRoot configuration = new ConfigurationBuilder().SetBasePath(Directory.GetCurrentDirectory()).AddJsonFile(Directory.GetCurrentDirectory() + "/../SystemAPI/appsettings.json").Build();
